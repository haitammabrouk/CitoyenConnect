    ...
    <div>
        ...
        <div className="page-content min-h-screen">
            <div className="sections-content flex justify-evenly pt-6">
                ...
                <h1 className="text-2xl font-semibold text-[#336C4E] pb-2 pt-6 border-b border-b-[#B0B0B0]">Demande de Signature</h1>
                    ...
                    <div className="parts flex flex-wrap justify-around">
                        ...
                        <div className="second-part space-y-6">
                            <div className="document">
                                <label className="text-xs font-semibold block pb-3" htmlFor="document">Document (à signer) <span className="text-[#FF0000]">*</span></label>
