...
function FonctionnaireConsultationProfil() {
    ...
    useEffect(() => {
        axios.get(`http://localhost:8080/admin/${sessionId}`)
        .then((response) => {
            setAdmin(response.data);
            console.log(response.data)
        }).catch((error) => {
            console.log("error fetching administrateur informations ", error);
        });
    }, [sessionId]);
                        ...
                        <div className="parts flex flex-wrap justify-around">
                            <div className="first-part space-y-6">
                                <div className="cin">
                                    ...
                                    <input value={admin.cin} className="border border-[#B0B0B0] h-12 w-96 pl-2 rounded-3xl outline-none" type="text" id="cin" name="cin" disabled />
                                </div>
                                <div className="nom">
                                    <label className="text-xs font-semibold block pb-3" htmlFor="nom">Nom <span className="text-[#FF0000]">*</span></label>
                                    <input value={admin.nom} className="border border-[#B0B0B0] h-12 w-96 pl-2 rounded-3xl outline-none" type="text" id="nom" name="nom" disabled />
                                </div>
                                <div className="prenom">
                                    <label className="text-xs font-semibold block pb-3" htmlFor="prenom">Prenom <span className="text-[#FF0000]">*</span></label>
                                    <input value={admin.prenom} className="border border-[#B0B0B0] h-12 w-96 pl-2 rounded-3xl outline-none" type="text" id="prenom" name="prenom" disabled />
                                </div>
                                <div className="phone">
                                    <label className="text-xs font-semibold block pb-3" htmlFor="phone">Nº Telephone  <span className="text-[#FF0000]">*</span></label>
                                    <input value={admin.phone} className="border border-[#B0B0B0] h-12 w-96 pl-2 rounded-3xl outline-none" type="text" id="phone" name="phone" disabled />
                                </div>
                                <div className="email">
                                    <label className="text-xs font-semibold block pb-3" htmlFor="email">Email <span className="text-[#FF0000]">*</span></label>
                                    <input  value={admin.email} className="border border-[#B0B0B0] h-12 w-96 pl-2 rounded-3xl outline-none" type="text" id="email" name="email" disabled />
                                </div>
                                <div className="date">
                                    <label className="text-xs font-semibold block pb-3" htmlFor="date">Date de naisance <span className="text-[#FF0000]">*</span></label>
                                    <input value={admin.date} className="border border-[#B0B0B0] pr-2 h-12 w-96 pl-2 rounded-3xl outline-none" type="date" id="date" name="date" disabled />
                                </div>
                                <div className="lieu">
                                    <label className="text-xs font-semibold block pb-3" htmlFor="lieu">Lieu de naissance <span className="text-[#FF0000]">*</span></label>
                                    <input value={admin.lieuNaissance}  className="border border-[#B0B0B0] h-12 w-96 pl-2 rounded-3xl outline-none" type="text" id="lieu" name="lieu" disabled />
                                </div>
                                <div className="nationalite">
                                    ...
                                    <input  value={admin.nationalite} className="border border-[#B0B0B0] h-12 w-96 pl-2 rounded-3xl outline-none" type="text" id="nationalite" name="nationalite" disabled />
                                </div>
                                <div className="situation">
                                    ...
                                    <input value={admin.situationFamiliale} className="border border-[#B0B0B0] h-12 w-96 pl-2 rounded-3xl outline-none" type="text" id="situation" name="situation" disabled />
                                </div>
                                <div className="sexe">
                                    <label className="text-xs font-semibold block pb-3" htmlFor="sexe">Sexe <span className="text-[#FF0000]">*</span></label>
                                    <input value={admin.sexe} className="border border-[#B0B0B0] h-12 w-96 pl-2 rounded-3xl outline-none" type="text" id="sexe" name="sexe" disabled />
                                </div>
                            ...
                            <div className="second-part space-y-6">
                                <div className="pwd">
                                    ...
                                    <input value={admin.password} className="border border-[#B0B0B0] h-12 w-96 pl-2 rounded-3xl outline-none" type="password" id="pwd" name="pwd" disabled />
                                    <Link to = '/modification-mdp-admin' className="text-[#4A4D49] block pt-1 pl-2 text-sm underline">Mot de passe oublié ?</Link>
                                </div>
                                <div className="cin_pere">
                                    ...
                                    <input value={admin.cin_pere} className="border border-[#B0B0B0] h-12 w-96 pl-2 rounded-3xl outline-none" type="text" id="cin_pere" name="cin_pere" disabled />
                                </div>
                                <div className="nom_pere">
                                    ...
                                    <input value={admin.nom_pere}  className="border border-[#B0B0B0] h-12 w-96 pl-2 rounded-3xl outline-none" type="text" id="nom_pere" name="nom_pere" disabled />
                                </div>
                                <div className="prenom_pere">
                                    ...
                                    <input value={admin.prenom_pere} className="border border-[#B0B0B0] h-12 w-96 pl-2 rounded-3xl outline-none" type="text" id="prenom_pere" name="nom_pere" disabled />
                                </div>
                                <div className="cin_mere">
                                    ...
                                    <input value={admin.cin_mere} className="border border-[#B0B0B0] h-12 w-96 pl-2 rounded-3xl outline-none" type="text" id="cin_mere" name="cin_mere" disabled />
                                </div>
                                <div className="nom_mere">
                                    ...
                                    <input value={admin.nom_mere} className="border border-[#B0B0B0] h-12 w-96 pl-2 rounded-3xl outline-none" type="text" id="nom_mere" name="nom_mere" disabled />
                                </div>
                                <div className="prenom_mere">
                                    ...
                                    <input value={admin.prenom_mere}  className="border border-[#B0B0B0] h-12 w-96 pl-2 rounded-3xl outline-none" type="text" id="prenom_mere" name="prenom_mere" disabled />
                                </div>
                                <div className="image">
...
export default FonctionnaireConsultationProfil