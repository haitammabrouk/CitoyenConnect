...
import DemandeEgalisationCardList from '../components/DemandeEgalisationCardList'
import DemandeEgalisationCardDetails from "../components/DemandeEgalisationCardDetails"


function FonctionnaireDemandesEgalisation() {
            ...
            <div className="sections-content flex justify-center flex-wrap items-baseline pt-10">
                ...
                <div className="second pl-6">
                    <div className="second-content">
                        {selectedInscription && <DemandeEgalisationCardDetails id = {id} 
...
export default FonctionnaireDemandesEgalisation