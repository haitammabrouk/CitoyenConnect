    ...
    <div className="w-full font-cairo">
        ...
        <div className="page-content min-h-screen">
            <div className="sections-content flex justify-evenly pt-6">
                ...
                {check && (
                     <div className=" mt-4 text-bold text-green-500">Votre réclamation a été soumise avec succès.Un email vous sera envoyé dans les plus tard possible en réponse à votre réclamation.</div>
                )}
