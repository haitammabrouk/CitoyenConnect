    ...
    <div className='font-cairo border border-[#2557A7] w-96 rounded-xl px-2 my-3'>
        <a href="#">
            <div className="content space-y-2">
                ...
                <p ><span className='font-semibold'>ID Reclamation</span> : AX12</p>
                <p className='text-sm border-b border-b-[#a7a9a7] pb-2'>Réclamée le <span className='text-[#727572]'>07/09/2003</span></p>
