...
function DemandeEgalisationCardDetails({ inscription, nom, prenom, id, date }) {


  return (
    <div className='font-cairo border border-[#727572] w-insc rounded-md pb-2'>
        <div className="content space-y-2 pb-4 px-4">
                <h1 className='text-xl font-semibold pt-2 '>Demande D'égalisation</h1>
            ...
            <div className="infos-content space-y-6 pb-3">
                <div className="message pt-3">
                    <ul className='text-md text-[#636363] font-semibold  flex justify-around space-x-3'>
                        <li className='border-r border-r-[#000000]'><p>Pour égaliser la demande, sélectionnez 'Égaliser la Demande'</p>
...
export default DemandeEgalisationCardDetails